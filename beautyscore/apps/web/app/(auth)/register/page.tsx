  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <p style={{ fontSize: '0.75rem', color: '#8C8177', marginBottom: '16px' }}>
          Регистрируясь, вы соглашаетесь с{' '}
          <Link href="/terms" style={{ color: '#2D7A4F', textDecoration: 'none' }}>
            Условиями использования
          </Link>{' '}
          и{' '}
          <Link href="/privacy" style={{ color: '#2D7A4F', textDecoration: 'none' }}>
